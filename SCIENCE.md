...
- **Gaia DR3** (astrometry, photometry, astrophysical parameters,
  ...
  [Gaia Collaboration, Vallenari A. et al. 2023](/data/papers/index.md#vallenari2023). Licence
  ...
  `data/gaia/README.md`. The roles the rest of the model rests on:
    - **Membership** — every `gaia_source` row at `G ≤ 11` is the magnitude
      ...
      nonetheless complete for a `V ≤ 11` floor, because the [Riello](/data/papers/index.md#riello2021) relation
...
- **Classic-designation cross indexes** (HD / HR / Bayer / Flamsteed /
  ...
  CDS:
    - `IV/25/tyc2_hd` — [Fabricius, Makarov, Knude & Wycoff 2002](/data/papers/index.md#fabricius2002a).
      HD ↔ Tycho-2, with the upstream `n_HD`/`n_TYC`
      ambiguity flags.
    - `IV/27A/catalog` — [Kostjuk N.D. 2002](/data/papers/index.md#kostjuk2002). Bayer + Flamsteed ↔
      HD/HR/HIP (as TAP serves it, the Bayer/Flamsteed-bearing subset).
    - `V/50/catalog` — [Hoffleit & Warren 1991](/data/papers/index.md#hoffleit1991), Bright Star
      Catalogue 5th revised ed. HR ↔ HD.
    - `J/A+A/670/A19/cns5` — [Golovin, Reffert, Just, Jordan, Vani &
      Jahreiß 2023](/data/papers/index.md#golovin2023). GJ ↔ Gaia EDR3 source_id ↔ HIP,
...
- **GCVS 5.1** (variable-star catalogue + cross-identification):
  http://www.sai.msu.su/gcvs/gcvs/ — [Samus et al. 2017](/data/papers/index.md#samus2017), Sternberg Astronomical
...
- **Hipparcos CCDM + MultFlag cross-reference**: VizieR
  ...
  stars ([Dommanget & Nys 1994](/data/papers/index.md#dommanget1994)); `MultFlag` is Hipparcos's own
...
- **Washington Double Star Catalog (WDS)** + **Sixth Catalog of Orbits
  of Visual Binary Stars (ORB6)**: [Mason et al. 2001](/data/papers/index.md#mason2001) (WDS);
  [Hartkopf, Mason & Worley 2001](/data/papers/index.md#hartkopf2001) (ORB6).
...
- **Gaia DR2↔(E)DR3 cross-match** (`gaiadr3.dr2_neighbourhood`):
  [Torra et al. 2021](/data/papers/index.md#torra2021) — the DPAC-published mapping between DR2 and (E)DR3 source_ids with
...
- **Edenhofer et al. 2024 3D dust map** (interstellar extinction + ISM density):
  [Edenhofer et al. 2024](/data/papers/index.md#edenhofer2024); data
...
- **Planet surface/cloud maps** (per-body equirectangular textures,
  ...
  Voyager 2 ring parameters ([French et al. 1991](/data/papers/index.md#french1991) in *Uranus*;
  [Porco et al. 1995](/data/papers/index.md#porco1995) in *Neptune and Triton* — per-file rows in
...
- **Moon surface maps** (13 of the 18 major moons, retrieved
  ...
  [Schenk/LPI 2014](/data/papers/index.md#schenk2014) Cassini enhanced-colour mosaics (PIA18434–18439)
  for the mid-sized Saturnians, chroma-halved toward their true
  near-neutral ice tones; [Schenk](/data/papers/index.md#schenk2014)'s Voyager 2 mosaic (PIA18668) for
...
- **Milky Way integrated properties and structure** (the volumetric band's
  ...
  [BC03](/data/papers/index.md#bruzual2003) grid below):
    - [**Bland-Hawthorn & Gerhard 2016**](/data/papers/index.md#blandhawthorn2016). Table 2 gives the Galaxy's
      ...
      1980](/data/papers/index.md#bahcall1980): M_V = −20.5; [de Vaucouleurs 1983](/data/papers/index.md#devaucouleurs1983): M_B = −20.2 ±
      0.15).
    ...
    - [**Bruzual & Charlot 2003**](/data/papers/index.md#bruzual2003) — GALAXEV SSP grids,
      `data/bc03/`. Supplies Υ\*_V for the bulge's old, metal-rich
      population, which is what turns [Licquia & Newman](/data/papers/index.md#licquia2015)'s mass B/T into
      the V-band light ratio the solve actually needs.
  [Bland-Hawthorn & Gerhard](/data/papers/index.md#blandhawthorn2016)'s M_V = −21.37 is the INPUT: both components'
