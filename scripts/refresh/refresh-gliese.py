...
Gliese 1991 (/data/papers/index.md#gliese1991) third catalogue of nearby stars.
...
GLIESE = VizierSlice(
    ...
    columns={
        ...
        "n_RV": "n_rv",
        "HD": "hd",
        "RAB1950": "ra_b1950_deg",
        "DEB1950": "de_b1950_deg",
        "pm": "pm_arcsec_yr",
        "pmPA": "pm_pa_deg",
        "DM": "dm",
        "Giclas": "giclas",
    ...
    schema={
        ...
        "RV": float, "n_RV": str,
        "HD": int,
        "RAB1950": float, "DEB1950": float,
        "pm": float, "pmPA": float,
        "DM": str, "Giclas": str, "LHS": str, "OtherName": str,
    },
    row_count_min=3_700,
    row_count_max=3_900,
    order_by=("Name", "Comp"),
