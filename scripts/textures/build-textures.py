...
# Schenk 2014 (/data/papers/index.md#schenk2014) enhanced-colour mosaics
# (the 2014 Cassini IR-G-UV icy-moon series + the Voyager 2 Triton map): the colour
...
# /data/textures/README.md#ring-strips--true-opacity-and-the-8-bit-floor). span_km MUST match the
...
def build_body(name: str, src_name: str, manifest: dict, ladder: dict) -> None:
    ...
    if im.mode not in ("RGB", "L"):
        im = im.convert("RGB")
    # Per-body treatments — rationale in /data/textures/README.md#colour-fidelity--index-anchored-calibration.
    # Bodies with a published disc-integrated index
...
def write_ladder_module(ladder: dict) -> None:
    ...
    LADDER_MODULE.write_text(
        ...
        "// body shares (/scripts/textures/README.md#size-ladder).\n\n"
