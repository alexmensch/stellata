...
// Mallama 2017 (/data/papers/index.md#mallama2017)
...
// (B−V, V−R, system) per body, as PUBLISHED. Planets: Mallama 2017
// (/data/papers/index.md#mallama2017), Table 3 reference rows (Saturn V−Rc
// from its internally-consistent synthetic pair). Satellites: Frey 1974
// (/data/papers/index.md#frey1974), Table IV, whose R band its Table
...
describe('texture colour calibration manifest', () => {
  ...
  it('documents the corrections it exists to make', () => {
    ...
    // measured tone, consistent with Irwin 2024
