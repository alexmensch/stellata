// The /docs/catalog-driver.md#61-record-parity dropped list: its committed shape, its closed reason enum, and the
...
/** The closed enum /docs/catalog-driver.md#61-record-parity requires, for this membership event.
