...
describe('parallax-cascade / the precision floor', () => {
  ...
  // record-parity park (/docs/catalog-driver.md#61-record-parity) — so those rows neither shipped nor parked.
  it('refuses a sub-floor parallax on every tier below Gaia, and parks each '
    ...
    for (const [src, tier, mas] of subFloor) {
      ...
      // no_parallax_published on the record-parity ledger (/docs/catalog-driver.md#61-record-parity) the parity gate subtracts,
