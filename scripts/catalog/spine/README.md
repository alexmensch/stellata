...
[Bailer-Jones et al. 2021](/data/papers/index.md#bailerjones2021) pull moving one row past the distance cutoff) would make a regeneration
...
- **Record parity — zero drops.** `recordCount` was unchanged across the
  ...
  63,676 more — and quoting it invites a later reader to take it for the
...
- **Field parity, over the 794.** |ΔV| p50 **0.050** · p99 0.932 · max
  ...
  The median V move is the [Riello et al. 2021](/data/papers/index.md#riello2021)
  ...
  [Bailer-Jones et al. 2021](/data/papers/index.md#bailerjones2021) posterior of
  1671 pc on it — where
