...
- **`tyc2_hd.tsv`** ← VizieR `IV/25/tyc2_hd`.
  [Fabricius, Makarov, Knude & Wycoff 2002](/data/papers/index.md#fabricius2002a) — the HD identifications for Tycho-2.
  ...
  16 with `n_tyc` > 1).
- **`cross_index.tsv`** ← VizieR `IV/27A/catalog`. [Kostjuk N.D. 2002](/data/papers/index.md#kostjuk2002) —
...
- **`bsc5.tsv`** ← VizieR `V/50/catalog`. [Hoffleit & Warren 1991](/data/papers/index.md#hoffleit1991),
