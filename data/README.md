...
| [`membership/`](membership/README.md) | Pipeline-derived membership manifest (`build:membership`): the primaries-derived record set that retires the spine, its § 6.1 additions ledger, and the binding review queue. |
...
minority advances (see `docs/science-catalog-ingestion.md` § Driver astrometry). The solar system is the
