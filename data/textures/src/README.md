...
| `europa-usgs-global.jpg` | Europa | USGS "Europa Voyager - Galileo SSI Global Mosaic 500m", frozen at 8192×4096 grayscale (measured chroma 0.00), a reduction made at retrieval 2026-08-19 from the full 19631×9816 GeoTIFF (193 MB), NASA/JPL/USGS. PositiveWest, centre 180° — build flips. **Un-imaged south polar band, −90° to −84.1°** (3.3% of the map, measured). Near-neutral body, and grayscale: all of its rendered colour comes from the index-anchored calibration gains, not from the source | Public domain | https://astrogeology.usgs.gov/search/map/europa_voyager_galileo_ssi_global_mosaic_500m |
| `ganymede-usgs-clr.jpg` | Ganymede | USGS "Ganymede Voyager - Galileo SSI Global Color Mosaic 1435m" ([Kersten et al. 2021](/data/papers/index.md#kersten2021)), frozen at 8192×4096 RGB, a reduction made at retrieval 2026-08-19 from the full 11520×5760 GeoTIFF (199 MB), NASA/JPL/USGS/DLR. PositiveEast, centre 180°. Genuine colour, not tinted (measured chroma 13.6). Fully imaged: the 5 black north-polar rows the 4096 reduction carried were the equirect singularity, and at 8192 they average away entirely | Public domain | https://astrogeology.usgs.gov/search/map/Ganymede/Voyager-Galileo/Ganymede_Voyager_GalileoSSI_Global_ClrMosaic_1435m |
| `callisto-usgs-global.jpg` | Callisto | USGS "Callisto Voyager - Galileo SSI Global Mosaic 1km", frozen at 8192×4096 grayscale (measured chroma 0.00), a reduction made at retrieval 2026-08-19 from the full 15138×7569 GeoTIFF (115 MB), NASA/JPL/USGS. PositiveWest, centre 180° — build flips. Near-neutral body, and grayscale: all of its rendered colour comes from the index-anchored calibration gains, not from the source | Public domain | https://astrogeology.usgs.gov/search/map/callisto_voyager_galileo_ssi_global_mosaic_1km |
| `mimas-pia18437.jpg` | Mimas | Cassini ISS global colour mosaic (PIA18437, 6356×3178, [Schenk/LPI 2014](/data/papers/index.md#schenk2014) series, IR-G-UV enhanced colour), NASA/JPL-Caltech/SSI/LPI. Retrieved 2026-07-19. Enhanced colour, pulled halfway to gray at build (by eye, not a measurement) | Public domain | https://photojournal.jpl.nasa.gov/catalog/PIA18437 |
...
| `titan-iss-p19658.tif` | Titan | USGS "Titan ISS PIA19658 Global Mosaic 4km" (938 nm surface mosaic behind the haze, 4040×2020 grayscale, measured chroma 0.00), NASA/JPL/USGS. The visible body is haze and none of this map's colour is imaged: all of its rendered colour comes from the index-anchored calibration gains, not from the source. PositiveWest, centre 180° — build flips. Retrieved 2026-07-19 | Public domain | https://astrogeology.usgs.gov/search/map/Titan/Cassini/Global-Mosaic/Titan_ISS_P19658_Mosaic_Global_4km |
...
| `triton-pia18668.jpg` | Triton | Voyager 2 global colour mosaic (PIA18668, 14138×7069, [Schenk/LPI 2014](/data/papers/index.md#schenk2014)). Un-imaged north polar band, **+90° to +43.2°** (26.0% of the map, measured; real data gap). Enhanced colour, pulled halfway to gray at build (by eye, not a measurement) | Public domain | https://photojournal.jpl.nasa.gov/catalog/PIA18668 |
| `rings-uranus.tsv` | Uranus rings | Authored table (not a download), values compiled 2026-07-18: the 10 narrow main rings' mid radii from the Earth-based + Voyager 2 occultation orbit fits ([French et al. 1988](/data/papers/index.md#french1988) Tables XIV–XV, to within 1 km; [Esposito 2002](/data/papers/index.md#esposito2002) Table 1, exactly), mean widths and mid-range normal optical depths credited to [French et al. 1991](/data/papers/index.md#french1991) in *Uranus* — no held copy, so those two columns are unverified | n/a (measured values) | per-occultation fits: [French et al. 1986](/data/papers/index.md#french1986) |
| `rings-neptune.tsv` | Neptune rings | Authored table (not a download), values compiled 2026-07-18: Galle/Le Verrier/Lassell/Arago/Adams radii, widths and normal optical depths from Voyager 2 + stellar occultations ([Porco et al. 1995](/data/papers/index.md#porco1995) in *Neptune and Triton*); Adams τ is the azimuthal average folding in its arcs | n/a (measured values) | stellar occultations: [Nicholson et al. 1995](/data/papers/index.md#nicholson1995) |
