...
| `mimas-pia18437.jpg` | Mimas | Cassini ISS global colour mosaic (PIA18437, 6356×3178, [Schenk 2014](/data/papers/index.md#schenk2014) series, IR-G-UV enhanced colour), NASA/JPL-Caltech/SSI/LPI. Retrieved 2026-07-19. Enhanced colour, pulled halfway to gray at build (by eye, not a measurement) | Public domain | https://photojournal.jpl.nasa.gov/catalog/PIA18437 |
...
| `triton-pia18668.jpg` | Triton | Voyager 2 global colour mosaic (PIA18668, 14138×7069, [Schenk 2014](/data/papers/index.md#schenk2014)). Un-imaged north polar band, **+90° to +43.2°** (26.0% of the map, measured; real data gap). Enhanced colour, pulled halfway to gray at build (by eye, not a measurement) | Public domain | https://photojournal.jpl.nasa.gov/catalog/PIA18668 |
| `rings-uranus.tsv` | Uranus rings | Authored table (not a download), values compiled 2026-07-18: the 10 narrow main rings' mid radii from the Earth-based + Voyager 2 occultation orbit fits ([French 1988](/data/papers/index.md#french1988) Tables XIV–XV, to within 1 km; [Esposito 2002](/data/papers/index.md#esposito2002) Table 1, exactly), mean widths and mid-range normal optical depths credited to [French 1991](/data/papers/index.md#french1991) in *Uranus* — no held copy, so those two columns are unverified | n/a (measured values) | per-occultation fits: [French 1986](/data/papers/index.md#french1986) |
| `rings-neptune.tsv` | Neptune rings | Authored table (not a download), values compiled 2026-07-18: Galle/Le Verrier/Lassell/Arago/Adams radii, widths and normal optical depths from Voyager 2 + stellar occultations ([Porco 1995](/data/papers/index.md#porco1995) in *Neptune and Triton*); Adams τ is the azimuthal average folding in its arcs | n/a (measured values) | stellar occultations: [Nicholson 1995](/data/papers/index.md#nicholson1995) |
