...
export class LocalBubbleShell extends FresnelShell {
  ...
  constructor(materials: ShellMaterials) {
    ...
    // local stars inside it composite on top. See /src/client/scene/README.md#full-render-stack--front-to-back.
    super(
  ...
  attach(data: LocalBubbleMesh): void {
    ...
    this.setRimParams(rimDistancesForExtent(data.extentPc));
