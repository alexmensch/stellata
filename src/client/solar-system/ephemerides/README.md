...
[Standish](/data/papers/index.md#standish1992)'s published budget for the Table 2a elements
...
- **Lazy, and not on the critical path.** `main.ts` fires
  ...
  every planet is on [Standish](/data/papers/index.md#standish1992) and the scene is simply the old one.
...
but [Standish](/data/papers/index.md#standish1992)'s EM Bary row carries `I = −0.00054346°`, and a test reading
...
([Meeus](/data/papers/index.md#meeus), ch. 47): 60 longitude / 60 latitude /
...
`../../util/precession.ts`'s [Vondrák](/data/papers/index.md#vondrak2011) long-term model supplies it.
...
correction [Espenak](/data/papers/index.md#espenak2006)'s eclipse canons apply for the lunar tidal
...
floor — [Meeus](/data/papers/index.md#meeus) quotes ~10″ ≈ 19 km near the present), **≲30 km over the
...
ecliptic). `earthMoonSplit` then divides [Standish](/data/papers/index.md#standish1992)'s EM-barycentre into
...
and jointly resolves the Earth slot + Moon slot from the [Standish](/data/papers/index.md#standish1992)
...
element source that positions the bodies** (Sol: live [Standish](/data/papers/index.md#standish1992)
...
(`../../chrome-lines/README.md`); the rings draw only in the local depth
pass. Colour and alpha are the
...
- **Ecliptic ↔ equatorial obliquity.** Don't open-code it a fifth time:
  ...
  term — [Standish](/data/papers/index.md#standish1992)'s accuracy budget doesn't need it and the
