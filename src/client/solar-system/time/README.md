...
`t` itself is clamped to the [Standish 1992](/data/papers/index.md#standish1992) ephemeris validity window
...
**The ephemerides do not.** JPL's element tables and the [Standish 1992](/data/papers/index.md#standish1992) series
...
`delta-t-pure.ts` is the [Espenak 2006](/data/papers/index.md#espenak2006) Canon Sect. 2.7 polynomial set (−1999 to +3000),
thirteen fitted intervals with the [Morrison 2004](/data/papers/index.md#morrisonstephenson) long-term
...
and **20.5 hours at 3000 BC** — 308° of Earth rotation. A fixed offset
...
**Known departure.** [Espenak 2006](/data/papers/index.md#espenak2006)'s 2005–2050 segment was extrapolated in
