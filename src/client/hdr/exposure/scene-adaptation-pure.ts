 ...
 *  brilliant dot /docs/science-hdr-pipeline.md#32-what-the-model-does-and-does-not-fix says it should. */
 ...
 *  luminance is an input (/docs/science-hdr-pipeline.md#32-what-the-model-does-and-does-not-fix's sensitivity analysis). */
