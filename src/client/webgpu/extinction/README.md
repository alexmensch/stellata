...
are `recordCount` (388,066 — `../../../../scripts/catalog/build-catalog-expected.json`)
...
taps, 388,066 × 48. That is the whole per-recompute cost and it is paid
...
texel, including the 30 past the catalog, because the pass has no
