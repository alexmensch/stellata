...
are `recordCount` (384,113 — `../../../../scripts/catalog/build-catalog-expected.json`)
...
taps, 384,113 × 48. That is the whole per-recompute cost and it is paid
...
texel, including the 911 past the catalog, because the pass has no
