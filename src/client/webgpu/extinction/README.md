...
are `recordCount` (388,063 — `../../../../scripts/catalog/build-catalog-expected.json`)
...
taps, 388,063 × 48. That is the whole per-recompute cost and it is paid
...
texel, including the 33 past the catalog, because the pass has no
