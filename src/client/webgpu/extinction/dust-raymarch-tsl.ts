...
// ./dust-raymarch-tsl.ts): the camera→star Edenhofer 2024 (/data/papers/index.md#edenhofer2024)
// march returning raw physical A_V, shared by the prepass and the star vertex fallback.
