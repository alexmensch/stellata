...
| `adaptation`            | `scene-adaptation.ts` `measure()` | Scene-luminance measurement: drawn bodies plus the near-camera star walk (`../hdr/exposure/README.md` § Adaptation). Zero in chart mode. |
