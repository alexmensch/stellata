...
const COMPOSITION: readonly string[] = [
  ...
  'clock', 'controls', 'declutter', 'disposed', 'exposure', 'exposureFrame', 'filters',
  'floatingOrigin', 'focus', 'galactic', 'hdr', 'hud', 'input', 'kinds', 'layers', 'localDepthPass', 'milkyway', 'monochrome',
